...
| **🎥 AI YouTube Video Analyzer** | Extracts video transcripts, metadata, and performs deep-dive sentiment/topic analysis with semantic summarization. | `google-genai`, `Streamlit`, `YouTube Transcript API` | [View Folder](ai-video-analyzer) |
